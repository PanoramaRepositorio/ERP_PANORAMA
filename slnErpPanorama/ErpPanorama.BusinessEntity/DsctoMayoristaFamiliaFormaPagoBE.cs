...
{
    [DataContract]
    public class DsctoMayoristaFamiliaFormaPagoBE
    {
        #region "Atributos"
        [DataMember]
        public Int32 IdDsctoMayoristaFamiliaFormaPago { get; set; }
        [DataMember]
        ...
        [DataMember]
        public Decimal DsctoTiendaMayorista { get; set; }
        [DataMember]
        public Boolean Adicional { get; set; }
        [DataMember]
