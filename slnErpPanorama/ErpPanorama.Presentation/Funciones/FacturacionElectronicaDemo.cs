...
{
    class FacturacionElectronicaDemo
    {
        ...
        public string GrabarVentaIntegrens(int IdEmpresa, int IdDocumentoVenta)
        {
            ...
            if (objE_DocumentoVenta.IdTipoDocumento == Parametros.intTipoDocTicketBoleta)
            {
                dr["altido"] = "03";//"01";
                dr["sersun"] = "B"+objE_DocumentoVenta.Serie;// "F001";
                dr["numsun"] = "00" + objE_DocumentoVenta.Numero;//"00000019";
            }
            else if(objE_DocumentoVenta.IdTipoDocumento == Parametros.intTipoDocTicketFactura)
            {
                dr["altido"] = "01";
                dr["sersun"] = "F"+objE_DocumentoVenta.Serie;// "F001";
                dr["numsun"] = "00" + objE_DocumentoVenta.Numero;//"00000019";
            }
            ...
            foreach (var item in lstTmpDocumentoVentaDetalle)
            {
                ...
                {
                    dr2["altido"] = "03";//"01";
                    dr2["sersun"] = "B" + objE_DocumentoVenta.Serie;// "F001";
                    dr2["numsun"] = "00" + objE_DocumentoVenta.Numero;//"00000019";
                }
                else if (objE_DocumentoVenta.IdTipoDocumento == Parametros.intTipoDocTicketFactura)
                {
                    dr2["altido"] = "01";
                    dr2["sersun"] = "F" + objE_DocumentoVenta.Serie;// "F001";
                    dr2["numsun"] = "00" + objE_DocumentoVenta.Numero;//"00000019";
                }
                ...
                {
                    dr2["valref"] = item.ValorUnitDscto;
                    //dr2["prelis"] = "0.000";
                    //dr2["totuni"] = item.ValorUnitario;
                }
            ...
            {
                dr3["altido"] = "03";//"01";
                dr3["sersun"] = "B" + objE_DocumentoVenta.Serie;// "F001";
                dr3["numsun"] = "00" + objE_DocumentoVenta.Numero;//"00000019";
            }
            else if (objE_DocumentoVenta.IdTipoDocumento == Parametros.intTipoDocTicketFactura)
            {
                dr3["altido"] = "01";
                dr3["sersun"] = "F" + objE_DocumentoVenta.Serie;// "F001";
                dr3["numsun"] = "00" + objE_DocumentoVenta.Numero;//"00000019";
            }
            ...
            dr4["numruc"] = Parametros.strEmpresaRuc;//"20330676826";
            ...
            dr4["nudoem"] = Parametros.strEmpresaRuc;//"20330676826";
            ...
            string MensajeService = WS.sendBill(dsCabecera.GetXml(), dsDetalle.GetXml(), dsCorreo.GetXml(), "<NewDataSet/>", "N");
        ...
        public string GrabarNotaCreditoIntegrens(int IdEmpresa, int IdDocumentoVenta)
        {
            ...
            dr3["numsun"] = objE_DocumentoVenta.Numero;//"00000019";
            dr3["nroitm"] = "1";
            dr3["tidoan"] = objE_DocumentoVenta.IdConTipoComprobantePagoRef;// "01";
            dr3["docant"] = objE_DocumentoVenta.SerieReferencia +"-"+ objE_DocumentoVenta.NumeroReferencia;//objE_DocumentoVenta.Serie + "-" + objE_DocumentoVenta.Numero;//  "F001-00000001";
            dr3["tidoem"] = "6";//Ruc de Panorama
            dr3["nudoem"] = Parametros.strEmpresaRuc;//"20330676826";EL ANTICIPO ????
            dr3["monant"] = 0;// objE_DocumentoVenta.Total;//"22687.69000";
