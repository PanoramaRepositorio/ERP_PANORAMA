...
{
      class FacturacionElectronicaSUNAT
    {
        ...
        private static Compania CrearEmisor()
        {
            return new Compania
            {
                NroDocumento = "10435468140",
                TipoDocumento = "6",
                NombreComercial = "",
                NombreLegal = "TAPIA HUAMAN SILVIA LILIANA",
                CodigoAnexo = "0000"
            };
        }
        ...
        private static Negocio ToNegocio(Compania compania)
        {
            return new Negocio
            {
                ...
                Provincia = "LIMA",
                Departamento = "LIMA",
                Direccion = "JR. ANDAHUAYLAS NRO. 787 INT. 103 LIMA - LIMA - LIMA",
                Ubigeo = "150101"
            };
        }
        ...
        public string CrearResumenDiario() //Anulación de boletas
        {
            try
            {
                ...
                lstDocumentoVenta = new DocumentoVentaBL().ListaPendienteBajaFE(21, Parametros.intTipoDocBoletaElectronica);
