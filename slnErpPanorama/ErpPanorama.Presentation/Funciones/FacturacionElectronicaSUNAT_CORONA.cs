...
{
      class FacturacionElectronicaSUNAT_CORONA
    {
       ...
       // private const string UrlSunat = "https://e-beta.sunat.gob.pe/ol-ti-itcpfegem-beta/billService";
        ...
        private static Compania CrearEmisor()
        {
            return new Compania
            {
                NroDocumento = "20506249601",
                TipoDocumento = "6",
                NombreComercial = "",
                NombreLegal = "CORONA IMPORTADORES E.I.R.L.",
                CodigoAnexo = "0000"
            };
        }
        ...
        private static Negocio ToNegocio(Compania compania)
        {
            return new Negocio
            {
                ...
                Provincia = "LIMA",
                Departamento = "LIMA",
                Direccion = "AV. GUILLERMO PRESCOTT 329 URB. COUNTRY CLUB",
                Ubigeo = "150131"
            };
        }
        ...
        public string CrearResumenDiario() //Anulación de boletas
        {
            try
            {
                ...
                lstDocumentoVenta = new DocumentoVentaBL().ListaPendienteBajaFE(3, Parametros.intTipoDocBoletaElectronica);
                ...
                var firmado = new FirmadoRequest
                {
                    ...
                    CertificadoDigital = Convert.ToBase64String(File.ReadAllBytes("20506249601.pfx")),
                    PasswordCertificado = "HBApanorama2021",
                };
