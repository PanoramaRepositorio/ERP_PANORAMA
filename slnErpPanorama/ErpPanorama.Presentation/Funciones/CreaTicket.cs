...
namespace ErpPanorama.Presentation.Funciones
{
    public class CreaTicket
    {
        ...
        public void AgregaArticuloCodigo2x1(int cant, string unidad, string codigo, double precio, double total)
        {
            if (cant.ToString().Length <= 4) // valida que cant precio y total esten dentro de rango
            {
                max = cant.ToString().Length;
                ...
                ticket += codigo.ToString() + "  "; // agrega Codigo
                //ticket += codigo.ToString() + "\n"; // agrega Codigo //ecm 2022
        ...
        #region "ecm"
        public void AgregaArticuloCodigo2x1(int cant, string unidad, string codigo, string precio, string total)
        {
            if (cant.ToString().Length <= 4) // valida que cant precio y total esten dentro de rango
            {
                max = cant.ToString().Length;
        ...
        public void AgregaArticuloDetalle2x1(string par1, string precio, string total)
        {
            if (precio.ToString().Length <= 10 && total.ToString().Length <= 11) // valida que cant precio y total esten dentro de rango
            {
                max = par1.Length;
                ...
                ticket = parte1;                             // agrega articulo
                max = 16 - (precio.ToString().Length);
                for (int i = 0; i < max; i++)                // **********
                {
                    ticket += " ";                           // Agrega espacios
                }                                            // **********
                ticket += precio.ToString(); // agrega precio
                max = 13 - (total.ToString().Length);
                for (int i = 0; i < max; i++)                // **********
                {
                    ticket += " ";                           // Agrega espacios
                }                                            // **********
        ...
        public void AgregaArticuloDetalleCeros(string par1, string precio, string total)
        {
            if (precio.ToString().Length <= 10 && total.ToString().Length <= 11) // valida que cant precio y total esten dentro de rango
            {
                max = par1.Length;
