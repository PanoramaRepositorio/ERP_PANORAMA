...
{
    public partial class frmRegVentaPedidoWeb : DevExpress.XtraEditors.XtraForm
    {
        #region "Propiedades"
        ...
        public frmRegVentaPedidoWeb()
        {
            InitializeComponent();
        }

        private void frmRegVentaPedidoWeb_Load(object sender, EventArgs e)
        {
            if (IdVendedor == 0)
            {
        ...
        public void InicializarModificar()
        {
            if (gvDocumentoVenta.RowCount > 0)
            {
                ...
                objDocumentoVenta.IdDocumentoVenta = int.Parse(gvDocumentoVenta.GetFocusedRowCellValue("IdDocumentoVenta").ToString());
                frmRegFacturacionEditWeb objRegFacturacionEdit = new frmRegFacturacionEditWeb();
                objRegFacturacionEdit.pOperacion = frmRegFacturacionEditWeb.Operacion.Modificar;
