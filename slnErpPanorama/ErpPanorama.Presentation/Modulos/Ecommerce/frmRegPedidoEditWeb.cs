...
{
    public partial class frmRegPedidoEditWeb : DevExpress.XtraEditors.XtraForm
    {
        #region "Propiedades"
        ...
        public int PedDelivery;
        public decimal CostoDelivery;
        public int IdPedidoWEB;

        public string wIdDepartamento;
        public string wIdProvincia;
        public string wIdDistrito;
        public string wDirReferencia;
        public string wDirDelivery;
        public string wEnvioAgencia;
        ...
        public decimal wTotal;
        public bool ActivoDelivery = false;

        #endregion

        #region "Eventos"

        public frmRegPedidoEditWeb()
        {
            InitializeComponent();
        }

        private void frmRegPedidoEditWeb_Load(object sender, EventArgs e)
        {
            ...
            if (Parametros.intPerfilId == Parametros.intPerAdministrador || Parametros.intPerfilId == Parametros.intPerAsistenteFacturacion || Parametros.intPerfilId == Parametros.intPerCoordinacionFacturacion|| Parametros.intPerfilId == Parametros.intPerSupervisorVentasPiso || Parametros.intPerfilId == Parametros.intPerAnalistaProducto)
            {
            ...
            else if (pOperacion == Operacion.Modificar)
            {
                ...
                objE_Pedido = new PedidoBL().SeleccionaWeb(IdPedidoWEB);
                ...
                if (objE_Pedido != null)
                {
                    ...
                    if (Parametros.strUsuarioLogin == "master" || Parametros.strUsuarioLogin == "ygomez" || Parametros.strUsuarioLogin == "mmurrugarra"
                        || Parametros.strUsuarioLogin == "liliana" || Parametros.strUsuarioLogin == "rcastañeda" || Parametros.strUsuarioLogin == "jzanabria" 
                        || Parametros.strUsuarioLogin == "dhuaman" || Parametros.strUsuarioLogin == "aflores" || Parametros.strUsuarioLogin == "nillanes" 
                    ...
                    if (Parametros.strUsuarioLogin == "master" || Parametros.strUsuarioLogin == "ygomez" || Parametros.strUsuarioLogin == "mmurrugarra"
                        || Parametros.strUsuarioLogin == "liliana" || Parametros.strUsuarioLogin == "rcastañeda" || Parametros.strUsuarioLogin == "jzanabria" 
                        || Parametros.strUsuarioLogin == "dhuaman" || Parametros.strUsuarioLogin == "nillanes" || Parametros.strUsuarioLogin == "aflores" 
                        || Parametros.intPerfilId == Parametros.intPerAdministrador || Parametros.intPerfilId == Parametros.intPerHelpDesk)
                    {
            ...
            btnDelivery.Enabled = false;
            btnInstalacion.Visible = false;
            btnDescuentoValeMarca.Visible = false;
            btnNuevo.Enabled = false;
            btnEditar.Enabled = false;
            btnEliminar.Enabled = false;
            btnClientePromocion.Enabled = false;
            btnCargarVale.Enabled = false;
            ...
            cboTipoDocumentoBusqueda.ReadOnly = true;
            cboMoneda.ReadOnly = true;
            cboCombo.ReadOnly = true;
            ...
            this.Text = "Pedido Ecommerce";
            if (PedDelivery == 2 || wEnvioAgencia == "ENVIO A AGENCIA")
            {
                btnDelivery.Enabled = true;
            }
            //else
            //{
            //    btnGrabar.Text = "&Enviar Almacén";
            //    btnGrabar.Width = 114;
            //}
            deFecha.EditValue = DateTime.Now;
            deFechaVencimiento.EditValue = DateTime.Now;
            ...
            if (e.KeyCode == Keys.Enter)
            {
                ...
                { 
                    ...
                    if (objE_Cliente != null)
                    {
                        ...
                        //Bloquear Ruc
                        //if (objE_Cliente.IdTipoDocumento == Parametros.intTipoDocumentoRUC)//add 06012015
                        //{
                        txtNumeroDocumento.Properties.ReadOnly = true;
                        //}
        ...
        private void nuevoToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                frmRegPedidoDetalleEditWeb movDetalle = new frmRegPedidoDetalleEditWeb();
                int i = 0;
                ...
                movDetalle.pOperacion = frmRegPedidoDetalleEditWeb.Operacion.Nuevo; //Add 07/07/15
                        ...
                        else
                        {
                            ...
                            if (mListaPedidoDetalleOrigen.Count == 0)
                            {
                                ...
                                if (Parametros.bValidarStockDetallePedido == true)
                                {
                                    ...
                                    {
                                        GrabarDesdeDetalle();
                                        CargaPedidoDetalle_ConsultaWeb();
        ...
        {
            if (Parametros.strUsuarioLogin == "master" || Parametros.strUsuarioLogin == "mmurrugarra" || Parametros.strUsuarioLogin == "ltapia" || Parametros.strUsuarioLogin == "ygomez"
                || Parametros.strUsuarioLogin == "rtapia" || Parametros.strUsuarioLogin.ToLower() == "aflores"/* || Parametros.strUsuarioLogin == "dhuaman" || Parametros.strUsuarioLogin == "liliana"*/ 
                || Parametros.intPerfilId == Parametros.intPerAdministrador || Parametros.intPerfilId == Parametros.intPerHelpDesk || Parametros.intPerfilId == Parametros.intPerAnalistaProducto)
            {
        ...
        private void btnGrabar_Click(object sender, EventArgs e)
        {
            ...
            {
                //PedDelivery = 0;
                if (wTotal!= Convert.ToDecimal(txtTotal.Text))
                {


                    XtraMessageBox.Show("El total del PEDIDO WEB no coincide con el total PEDIDO PANORAMA a generar.", this.Text, MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
                ...
                if (!ValidarIngreso())
                {
                    ...
                    objPedido.Periodo = deFecha.DateTime.Year; ;//Parametros.intPeriodo;
                    ...
                    objPedido.IdPedidoReferencia = IdPedidoReferencia == 0 ? (Int32?)null : null;//IdPedidoReferencia;
                    objPedido.Fecha = DateTime.Now.Date;   //Convert.ToDateTime(deFecha.DateTime.ToShortDateString());
                    objPedido.FechaVencimiento = DateTime.Now.Date;    //Convert.ToDateTime(deFechaVencimiento.DateTime.ToShortDateString());
                    ...
                    objPedido.IdPedidoWEB = IdPedidoWEB;
                    ...
                    if  (IdPedido==0) //(PedDelivery == 1)
                    {
                        ...
                        Numero = objBL_Pedido.InsertaWeb(objPedido, lstPedidoDetalle);
                    ...
                    else
                    {
                        ...
                        objPedido.IdPedidoWEB = IdPedidoWEB;
                        objBL_Pedido.ActualizaWeb(objPedido, lstPedidoDetalle);
                    }
                    ...
                    if (Convert.ToInt32(cboFormaPago.EditValue) == Parametros.intContado)
                    {
                        ...
                        objE_Pedido2 = new PedidoBL().SeleccionaImpresion(IdPedido);
                            ...
                            //{
                                ...
                                if (Imprimir)
                                {
                                    ...
                                    if (lstReporte.Count > 0)
                                    {
                                        if (PedDelivery == 1)
                                        {
                                            rptPedidoContadoTicketWeb objReporteGuia = new rptPedidoContadoTicketWeb();
                                            objReporteGuia.SetDataSource(lstReporte);
                                            objReporteGuia.SetParameterValue("Equipo", WindowsIdentity.GetCurrent().Name.ToString());
                                            objReporteGuia.SetParameterValue("Usuario", Parametros.strUsuarioLogin);
                                            objReporteGuia.SetParameterValue("Modificado", "Modif. N°(" + lstReporte[0].NumeroModificacion + ")");
                    ...
                    { 
                        ...
                        if (objE_Pedido != null)
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    if (frmAutoriza.Usuario == "master" || frmAutoriza.Usuario == "mmurrugarra" || frmAutoriza.IdPerfil == Parametros.intPerAdministrador
                                        || Parametros.intPerfilId == Parametros.intPerHelpDesk || frmAutoriza.Usuario == "ygomez")
                                    {
                                        #region "Pedido Normal"
        ...
        private void txtTotal_EditValueChanged(object sender, EventArgs e)
        {
            ...
            { 
                ...
                if (Parametros.strUsuarioLogin == "master" || Parametros.strUsuarioLogin == "mmurrugarra" || Parametros.strUsuarioLogin == "ygomez" || Parametros.strUsuarioLogin == "liliana" 
                    || Parametros.strUsuarioLogin == "rcastañeda"  || Parametros.strUsuarioLogin == "dhuaman" || ActivaCabeceraCaja 
        ...
        private void cboTipoVenta_EditValueChanged(object sender, EventArgs e)
        {
            ...
            {
                if (Parametros.strUsuarioLogin == "master" || Parametros.intPerfilId == Parametros.intPerAdministrador || Parametros.strUsuarioLogin == "mmurrugarra" || Parametros.strUsuarioLogin == "ygomez")
                {
        ...
        {
            frmDeliveryTarifaWeb movDetalle = new frmDeliveryTarifaWeb();
            movDetalle.wCostoDelivery = CostoDelivery;

            if (wIdDepartamento == "07" || wIdDepartamento == "15")
            {
                movDetalle.wIdDepartamento2 = wIdDepartamento;
                movDetalle.wIdProvincia2 = wIdProvincia;
                movDetalle.wIdDistrito2 = wIdDistrito;
            }
            ...
            if (movDetalle.ShowDialog() == DialogResult.OK)
            {
                ...
                string Distrito = wEnvioAgencia=="ENVIO A AGENCIA"? "ENVIO AGENCIA LIMA" : movDetalle.oBE.DescUbigeo.Trim().ToUpper();
                ...
                if (gvPedidoDetalle.RowCount > 0)
                {
                    frmRegGestionPedidoDespachoEditWeb frm = new frmRegGestionPedidoDespachoEditWeb();
                    frm.IdPedido = IdPedido;
                    frm.wDirReferencia2 = wDirReferencia;
                    frm.wDirDelivery2 = wDirDelivery;
                    frm.wObs2 = txtObservaciones.Text;
                    frm.wIdDepartamento3 = wIdDepartamento;

                    frm.pOperacion = frmRegGestionPedidoDespachoEditWeb.Operacion.Modificar;
                    frm.StartPosition = FormStartPosition.CenterParent;
                    frm.ShowDialog();
        ...
        private void cboVendedor_EditValueChanged(object sender, EventArgs e)
        {
            ...
            if (objE_Persona.IdCargo == Parametros.intDisenadorInteriorMaster || objE_Persona.IdCargo == Parametros.intDisenadorInteriorSenior || objE_Persona.IdCargo == Parametros.intDisenadorInteriorJunior)
            {
            ...
            try
            {
                ...
                if (Convert.ToInt32(cboFormaPago.EditValue) == Parametros.intContado)
                {
                    ...
                    else
                    {
                        ...
                        {
                            if (Parametros.intTiendaId == Parametros.intTiendaUcayali /*|| Parametros.intTiendaId == Parametros.intTiendaAndahuaylas*/) //add temp 29122017
                            {
        ...
        private void CargaPedidoDetalle()
        {
            ...
            List<PedidoDetalleBE> lstTmpPedidoDetalle = null;
            lstTmpPedidoDetalle = new PedidoDetalleBL().ListaTodosActivoWeb(IdPedidoWEB); /// .ListaTodosActivo (IdPedido);
            ...
            foreach (PedidoDetalleBE item in lstTmpPedidoDetalle)
            {
                ...
                objE_PedidoDetalle.IdPedido = item.IdPedido;
                objE_PedidoDetalle.IdPedidoDetalle = item.IdPedidoDetalle;
                objE_PedidoDetalle.Item = wContar; //item.Item;
                objE_PedidoDetalle.IdProducto = item.IdProducto;
                objE_PedidoDetalle.CodigoProveedor = item.CodigoProveedor;
                objE_PedidoDetalle.NombreProducto = item.NombreProducto;
                objE_PedidoDetalle.Abreviatura = item.Abreviatura;
        ...
        private void CargaPedidoDetalle_ConsultaWeb()
        {
            int wContar = 1;
            mListaPedidoDetalleOrigen = new List<CPedidoDetalle>();

            List<PedidoDetalleBE> lstTmpPedidoDetalle = null;
            lstTmpPedidoDetalle = new PedidoDetalleBL().ListaTodosActivo_ConsultaWeb(IdPedido); /// .ListaTodosActivo (IdPedido);
        ...
        public void Habilitar()
        {
            ...
            if (Parametros.strUsuarioLogin.ToLower() == "master" || Parametros.strUsuarioLogin == "mmurrugarra" || Parametros.strUsuarioLogin == "ygomez")
            {
        ...
        private void CargarProductoDelivery(int IdProducto, decimal Precio, string Distrito)
        {
            try
            {
                ...
                if (pProductoBE != null)
                {
                    ...
                    //if (Convert.ToDecimal(txtTotal.EditValue) > 250)
                    //{
                    //    Precio = 0;
                    //}
                    //IdLineaProducto = pProductoBE.IdLineaProducto;
                    ...
                    if (Convert.ToInt32(cboMoneda.EditValue) == Parametros.intSoles)
                    {
                        if (IdTipoCliente == Parametros.intTipClienteMayorista)
                        {
                            ...
                            gvPedidoDetalle.SetRowCellValue(gvPedidoDetalle.FocusedRowHandle, "Observacion", wEnvioAgencia == "ENVIO A AGENCIA" ? "ENVIO A AGENCIA LIMA" : "DELIVERY");
                            gvPedidoDetalle.SetRowCellValue(gvPedidoDetalle.FocusedRowHandle, "CodAfeIGV", Parametros.strGravadoOnerosa);
                            gvPedidoDetalle.SetRowCellValue(gvPedidoDetalle.FocusedRowHandle, "IdKardex", 0);
                            gvPedidoDetalle.SetRowCellValue(gvPedidoDetalle.FocusedRowHandle, "FlagMuestra", false);
                            gvPedidoDetalle.SetRowCellValue(gvPedidoDetalle.FocusedRowHandle, "FlagRegalo", false);
        ...
        private void GrabarDesdeDetalle()
        {
            try
            {
                ...
                if (!ValidarIngreso())
                {
                    ...
                    objPedido.IdPedidoWEB = IdPedido;
                    objPedido.IdPedido = IdPedido;
                    objPedido.IdTienda = IdTienda;//Parametros.intTiendaId;
                    objPedido.IdCampana = 3;
                    objPedido.Periodo = Periodo;//Parametros.intPeriodo;
                    objPedido.Mes = DateTime.Now.Month;  // deFecha.DateTime.Month;
                    objPedido.IdProforma = IdProforma == 0 ? (Int32?)null : IdProforma;
                    objPedido.IdTipoDocumento = Convert.ToInt32(cboDocumento.EditValue);
                    objPedido.Serie = "0";
                    objPedido.Numero = txtNumero.Text;
