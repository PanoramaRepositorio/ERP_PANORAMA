...
{
    public partial class frmRegFacturacionEditWeb : DevExpress.XtraEditors.XtraForm
    {
        #region "Propiedades"
        ...
        public frmRegFacturacionEditWeb()
        {
            InitializeComponent();
        }

        private void frmRegFacturacionEditWeb_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (e.KeyCode == Keys.Enter)
                {
                    ...
                    if (objE_Pedido != null)
                    {
                        ...
                        {
                            XtraMessageBox.Show("Steycy Farfan!, El pedido es CONTADO, se recomienda facturar por el módulo de ventas contado.\nPara más información consultar con el área de sistemas.", this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
                            return;
                        }
                        ...
                        if (Parametros.intTiendaId == Parametros.intTiendaUcayali)
                        {
                            ...
                            {
                                if (!objE_MovimientoPedido.Chequeado)
                                {
                                    if (objE_Pedido.Despachar == "ALMACEN")
                                    {
        ...
        private void btnGrabar_Click(object sender, EventArgs e)
        {
            if (!ValidarIngreso())
            {
                ...
                if (Convert.ToInt32(cboDocumento.EditValue) == Parametros.intTipoDocNotaCredito || Convert.ToInt32(cboDocumento.EditValue) == Parametros.intTipoDocNotaCreditoElectronica)
                {
                    ...
                    if (txtSerie.Text.Length != txtSerieReferencia.Text.Length)
                    {
                ...
                if (Convert.ToInt32(cboDocumento.EditValue) == Parametros.intTipoDocBoletaElectronica) //BOLETA ELECTRONICA
                {
                    ...
                    //PedidoBE objE_Pedido = new PedidoBL().SeleccionaSituacion(IdPedido);
                ...
                if (Convert.ToInt32(cboDocumento.EditValue) == Parametros.intTipoDocNotaCreditoElectronica) //CUANDO ES NOTA DE CREDITO ELECTRONICA
                {
                    #region "Diferencia cabecera vs detalle"
                    //PedidoBE objE_Pedido = new PedidoBL().SeleccionaSituacion(IdPedido);
                    //if (objE_Pedido.TotalDiferencia != 0)
        ...
        private void btnCambiarTC_Click(object sender, EventArgs e)
        {
            ...
            {
                if (frmAutoriza.Usuario == "master" || frmAutoriza.Usuario == "mmurrugarra" || frmAutoriza.Usuario == "ygomez")
                {
        ...
        private void InsertarEstadoCuenta()
        {
            if (!ValidarIngreso())
            {
                ...
                if (pOperacion == Operacion.Nuevo)
                {
                    ...
                    //InsertarEstadoCuentaDiseñador();//Comision
                }
        ...
        {
            if (Parametros.strUsuarioLogin == "master" || Parametros.strUsuarioLogin == "mmurrugarra" || Parametros.strUsuarioLogin == "ygomez" || Parametros.strUsuarioLogin == "oguevara")
            {
