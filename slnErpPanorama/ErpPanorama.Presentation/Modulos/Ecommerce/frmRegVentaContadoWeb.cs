...
{
    public partial class frmRegVentaContadoWeb : DevExpress.XtraEditors.XtraForm
    {
        #region "Propiedades"
        ...
        public frmRegVentaContadoWeb()
        {
            InitializeComponent();
        }

        private void frmRegVentaContadoWeb_Load(object sender, EventArgs e)
        {
            this.Top = 0;
            this.Left = 0;
        ...
        private void btnActualizarDocumentoVenta_Click(object sender, EventArgs e)
        {
            ...
            if (Convert.ToInt32(cboSituacion.EditValue) == Parametros.intFacturado)
            {
                frmRegVentaPedidoWeb objVentaPedido = new frmRegVentaPedidoWeb();
        ...
        private void InsertarDocumentoVenta(int IdEmpresaGenera, string TipoDoc)
        {
            try
            {
                ...
                objDocumentoVenta.IdPedidoWeb = objE_Pedido.IdPedidoWeb;
                ...
                objDocumentoVenta.Fecha = DateTime.Now.Date; // (deFecha.DateTime.ToShortDateString());
                objDocumentoVenta.FechaVencimiento = DateTime.Now.Date;  // Convert.ToDateTime(deFecha.DateTime.ToShortDateString());
        ...
        private void ImpresionDirecta(String TipoDoc, Int32 TipoFormato)
        {
            try
            {
        ...
        private void Cargar()
        {
            dtPedido = FuncionBase.ToDataTable(new PedidoBL().ListaContadoWeb(Parametros.intEmpresaId, Parametros.intTiendaId, deFecha.DateTime, Convert.ToInt32(cboSituacion.EditValue)));
        ...
        private void InsertarDocumentoVentaPagoVariosRUS(decimal Efectivo, decimal Visa, decimal MasterCard, decimal VisaPuntosVida, decimal MasterCardPuntosVida, string TipoVisa, string TipoMaster, int IdDocumentoNC, int IdTipoMaster)
        {
            try
            {
                //Traemos la información del pedido.
