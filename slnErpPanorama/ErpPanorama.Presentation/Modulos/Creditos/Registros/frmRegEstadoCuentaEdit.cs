...
{
    public partial class frmRegEstadoCuentaEdit : DevExpress.XtraEditors.XtraForm
    {
        #region "Propiedades"
        ...
        public frmRegEstadoCuentaEdit()
        {
            InitializeComponent();
        }

        private void frmRegEstadoCuentaEdit_Load(object sender, EventArgs e)
        {
            ...
            else if (pOperacion == Operacion.Modificar)
            {
                ...
                if (objE_EstadoCuenta.TipoMovimiento == "C")
                ...
                if (objE_EstadoCuenta.IdMovimientoCaja != null)
                {
