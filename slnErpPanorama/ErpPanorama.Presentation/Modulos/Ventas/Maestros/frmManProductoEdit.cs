...
{
    public partial class frmManProductoEdit : DevExpress.XtraEditors.XtraForm
    {
        #region "Propiedades"
        ...
        public frmManProductoEdit()
        {
            InitializeComponent();
        }

        private void frmManProductoEdit_Load(object sender, EventArgs e)
        {
        ...
        private void CargarPefilEditor()
        {
            if (Parametros.intPerfilId == Parametros.intPerAdministrador || Parametros.intPerfilId == Parametros.intPerJefeAlmacen || Parametros.intPerfilId == Parametros.intPerHelpDesk || 
                Parametros.strUsuarioLogin.ToUpper()=="aflores".ToUpper() || Parametros.strUsuarioLogin.ToUpper() == "jlquispe".ToUpper() || Parametros.strUsuarioLogin.ToUpper() == "cqueirolo".ToUpper()
