...
{
    public partial class frmManPromocion2x1Edit : DevExpress.XtraEditors.XtraForm
    {
        #region "Propiedades"
        ...
        int _IdPromocion2x1 = 0;

        public int IdPromocion2x1
        {
            get { return _IdPromocion2x1; }
            set { _IdPromocion2x1 = value; }
        }

        public Promocion2x1BE pPromocion2x1BE { get; set; }
        ...
        public frmManPromocion2x1Edit()
        {
            InitializeComponent();
        }

        private void frmManPromocion2x1Edit_Load(object sender, EventArgs e)
        {
            ...
            BSUtils.LoaderLook(cboTipo, CargarTipoPromocion(), "Descripcion", "Id", true);

            cboTipoCliente.ReadOnly = true;
            if (pOperacion == Operacion.Nuevo)
            {
                this.Text = "Promocion2x1 - Nuevo";
            }
            else if (pOperacion == Operacion.Modificar)
            {
                this.Text = "Promocion2x1 - Modificar";

                cboEmpresa.EditValue = pPromocion2x1BE.IdEmpresa;
                cboTipo.EditValue = pPromocion2x1BE.Tipo;
                IdPromocion2x1 = pPromocion2x1BE.IdPromocion2x1;
                txtDescPromocion2x1.Text = pPromocion2x1BE.DescPromocion2x1;
                cboTipoCliente.EditValue = pPromocion2x1BE.IdTipoCliente;
                cboFormaPago.EditValue = pPromocion2x1BE.IdFormaPago;
                deDesde.EditValue = pPromocion2x1BE.FechaInicio;
                deHasta.EditValue = pPromocion2x1BE.FechaFin;
                chkContado.Checked = pPromocion2x1BE.FlagContado;
                chkCredito.Checked = pPromocion2x1BE.FlagCredito;
                chkConsignacion.Checked = pPromocion2x1BE.FlagConsignacion;
                chkSeparacion.Checked = pPromocion2x1BE.FlagSeparacion;
                chkContraentrega.Checked = pPromocion2x1BE.FlagContraentrega;
                chkCopagan.Checked = pPromocion2x1BE.FlagCopagan;
                chkObsequio.Checked = pPromocion2x1BE.FlagObsequio;
                chkAsaf.Checked = pPromocion2x1BE.FlagAsaf;
                chkMayorista.Checked = pPromocion2x1BE.FlagClienteMayorista;
                chkMinorista.Checked = pPromocion2x1BE.FlagClienteFinal;
                chkUcayali.Checked = pPromocion2x1BE.FlagUcayali;
                chkAndahuaylas.Checked = pPromocion2x1BE.FlagAndahuaylas;
                chkPrescott.Checked = pPromocion2x1BE.FlagPrescott;
                chkAviacion2.Checked = pPromocion2x1BE.FlagAviacion2;
                chkSanMiguel.Checked = pPromocion2x1BE.FlagSanMiguel;
                chkWeb.Checked = pPromocion2x1BE.FlagWeb;

                if (Parametros.intPerfilId == Parametros.intPerAdministrador || Parametros.intPerfilId == Parametros.intPerCoordinadorVisualCentral || Parametros.intPerfilId == Parametros.intPerAsistenteCompras || Parametros.intPerfilId == Parametros.intPerAnalistaProducto)
                {
        ...
        private void btnGrabar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!ValidarIngreso())
                {
                    ...
                    objPromocion2x1.IdPromocion2x1 = IdPromocion2x1;
                    ...
                    objPromocion2x1.Tipo = cboTipo.Text; //"2x1";
                    ...
                    objPromocion2x1.FlagUcayali = chkUcayali.Checked;
                    objPromocion2x1.FlagAndahuaylas = chkAndahuaylas.Checked;
                    objPromocion2x1.FlagPrescott = chkPrescott.Checked;
                    objPromocion2x1.FlagAviacion2 = chkAviacion2.Checked;
                    objPromocion2x1.FlagSanMiguel = chkSanMiguel.Checked;
                    objPromocion2x1.FlagWeb = chkWeb.Checked;
        ...
        private void eliminartodotoolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (XtraMessageBox.Show("Está seguro de eliminar todo los registros?", this.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ...
                ojbE_PromocionDetalle.IdPromocion2x1 = IdPromocion2x1;
        ...
        private void exportartoolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            string _fileName = "ListadoPromocion2x1Detalle";
        ...
        private void CargaPromocion2x1Detalle()
        {
            ...
            lstTmpPromocion2x1Detalle = new Promocion2x1DetalleBL().ListaTodosActivo(IdPromocion2x1);
        ...
        private DataTable CargarTipoPromocion()
        {
            DataTable dt = new DataTable();
