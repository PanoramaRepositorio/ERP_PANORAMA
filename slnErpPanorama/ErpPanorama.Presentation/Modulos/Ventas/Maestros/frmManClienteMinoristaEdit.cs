...
{
    public partial class frmManClienteMinoristaEdit : DevExpress.XtraEditors.XtraForm
    {
        #region "Propiedades"
        ...
        private void frmManClienteMinoristaEdit_Load(object sender, EventArgs e)
        {
            ...
            if (Parametros.strUsuarioLogin == "master" || Parametros.strUsuarioLogin == "ltapia" || Parametros.strUsuarioLogin == "liliana" || Parametros.strUsuarioLogin == "pmoscaiza" 
               || Parametros.strUsuarioLogin == "nillanes" || Parametros.intPerfilId == Parametros.intPerSupervisorVentasPiso || Parametros.intPerfilId == Parametros.intPerAdministrador
               || Parametros.intPerfilId == Parametros.intPerAsesorDiseñoInterior
               || Parametros.intPerfilId == Parametros.intPerHelpDesk || Parametros.intPerfilId == Parametros.intPerJefeMarketingPublicidad || Parametros.intPerfilId == Parametros.intPerJefeRRHH)
            {
            ...
            else if (pOperacion == Operacion.Modificar)
            {
                ...
                chkComercioAmigo.Checked = objE_Cliente.FlagComercio;
            ...
            try
            {
               if (radioButton1.Checked)
                ...
                if (!ValidarIngreso())
                {
                    ...
                    objE_Cliente.FlagComercio = chkComercioAmigo.Checked;
