...
{
    public partial class frmManEscalaMayoristaPreVentaEdit : DevExpress.XtraEditors.XtraForm
    {
        #region "Propiedades"
        ...
        public frmManEscalaMayoristaPreVentaEdit()
        {
            InitializeComponent();
        }
        ...
        private void frmManDescuentoMayoristaLineaPagoEdit_Load(object sender, EventArgs e)
        {
            ...
            lstEscalaMayoristaBE = new EscalaMayoristaPreVentaBL().ListaTodosActivo(0, 0);
        }
        ...
        private void btnGrabar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!ValidarIngreso())
                {
                    ...
                    EscalaMayoristaPreVentaBL objBL_DsctoClienteMayorista = new EscalaMayoristaPreVentaBL();

                    objDsctoClienteMayorista.IdEscalaMayoristaPreVenta = IdDescuentoClienteMayorista;
            ...
            if (chkGeneral.Checked)
            {
                ...
                if (BuscarGeneral.Count > 0)
                {
                    if (XtraMessageBox.Show("¿Esta seguro de Poner el descuento General?, Se eliminaran todos los registros de la linea.", this.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                    {
                        ...
                        {
                            int id = item.IdEscalaMayoristaPreVenta;
                            EscalaMayoristaBE objE_Mayorista = new EscalaMayoristaBE();
                            objE_Mayorista.IdEscalaMayoristaPreVenta = id;
