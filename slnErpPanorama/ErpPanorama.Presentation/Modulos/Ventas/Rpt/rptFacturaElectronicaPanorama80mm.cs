...
namespace ErpPanorama.Presentation.Modulos.Ventas.Rpt {
    ...
    public class rptFacturaElectronicaPanorama80mm : ReportClass {
        
        public rptFacturaElectronicaPanorama80mm() {
        }
        
        public override string ResourceName {
            get {
                return "rptFacturaElectronicaPanorama80mm.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "ErpPanorama.Presentation.Modulos.Ventas.Rpt.rptFacturaElectronicaPanorama80mm.rpt" +
                    "";
            }
            set {
                // Do nothing
    ...
    public class CachedrptFacturaElectronicaPanorama80mm : Component, ICachedReport {
        
        public CachedrptFacturaElectronicaPanorama80mm() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptFacturaElectronicaPanorama80mm rpt = new rptFacturaElectronicaPanorama80mm();
            rpt.Site = this.Site;
            return rpt;
        }
