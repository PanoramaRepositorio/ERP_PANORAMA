...
{
    public partial class frmRegSolicitudReparacionEdit : DevExpress.XtraEditors.XtraForm
    {
        #region "Propiedades"
        ...
        public frmRegSolicitudReparacionEdit()
        {
            InitializeComponent();
        }

        private void frmRegSolicitudReparacionEdit_Load(object sender, EventArgs e)
        {
        ...
        private void btnGrabar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!ValidarIngreso())
                {
                    ...
                    objCambio.IdTipoDocumento = Parametros.intTipoDocReparacion;
                    ...
                    foreach (var item in mListaCambioDetalleOrigen)
                    {
                        ...
                        objE_CambioDetalle.ValorVentaSoles = item.ValorVentaSoles;
                        objE_CambioDetalle.ValorVentaDolares = item.ValorVentaDolares;
                        objE_CambioDetalle.Observacion = item.Observacion;
