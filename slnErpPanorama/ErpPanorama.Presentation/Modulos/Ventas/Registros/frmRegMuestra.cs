...
{
    public partial class frmRegMuestra : DevExpress.XtraEditors.XtraForm
    {
        #region "Propiedades"

        private List<MuestraBE> mLista = new List<MuestraBE>();
        
        #endregion

        #region "Eventos"

        public frmRegMuestra()
        {
            InitializeComponent();
        }

        private void frmRegMuestra_Load(object sender, EventArgs e)
        {
        ...
        private void tlbMenu_NewClick()
        {
            try
            {
                XtraMessageBox.Show("No se puede agregar, el ingreso es por el módulo de pedido seleccionando Tienda Ucayali", this.Text,MessageBoxButtons.OK,MessageBoxIcon.Stop);
        ...
        {
            XtraMessageBox.Show("No se puede editar, el ingreso es por el módulo de pedido seleccionando Tienda Ucayali", this.Text, MessageBoxButtons.OK, MessageBoxIcon.Stop);
