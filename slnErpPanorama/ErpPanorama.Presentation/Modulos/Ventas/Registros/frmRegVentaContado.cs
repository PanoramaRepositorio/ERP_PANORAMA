...
namespace ErpPanorama.Presentation.Modulos.Ventas.Registros
{
    public partial class frmRegVentaContado : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void frmRegVentaContado_Load(object sender, EventArgs e)
        {
            ...
            //{
            //    var value = cboEmpresa.Properties.GetDataSourceValue("RazonSocial", i);
        ...
        private void btnImprimirDocumento_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                objCajaEmpresa = new CajaEmpresaBL().Selecciona(Convert.ToInt32(valueId), Parametros.intTiendaId, Parametros.intCajaId);

                if (objCajaEmpresa == null)
                {
                    XtraMessageBox.Show("No se puede imprimir en esta Caja, pedido de " + value.ToString() + ",  \nConsulte con su Administrador", this.Text, MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
                ...
                //Valida si el RER es con boleta SOLO RER
                if ((Convert.ToInt32(valueId) == 3 || Convert.ToInt32(valueId) == 19 || Convert.ToInt32(valueId) == 21 || Convert.ToInt32(valueId) == 23 || Convert.ToInt32(valueId) == 8 || Convert.ToInt32(valueId) == 20) && TipoDocFact == Parametros.intTipoDocFacturaElectronica)
                {
                    continue;
                }
                if (valueId != Parametros.intIdPanoramaDistribuidores)
                {
                    ...
                    if (objE_Empresa != null)
                    {
                        if (objE_Empresa.IdRegimenTributario == Parametros.intRegimenTributarioRUS)// solo Rus
                        {
                            ...
                            if (!ValidarTopeEmpresaRus()) //Mensual
                            {
                                ...
                                {
                                    if (Convert.ToInt32(valueId) == 3 || Convert.ToInt32(valueId) == 19 || Convert.ToInt32(valueId) == 21 || Convert.ToInt32(valueId) == 23 || Convert.ToInt32(valueId) == 8 || Convert.ToInt32(valueId) == 20)
                                    {
                                        // Validacion de cliente mayorista para RER
                                        if (objE_Pedido.IdTipoCliente == 87)
                                        {
                                            //XtraMessageBox.Show("Solo puede emitir RER de " + value.ToString() + "\n a Clientes Finales.", this.Text, MessageBoxButtons.OK, MessageBoxIcon.Stop);
                                            Cargar();
                                            continue;
                                        }
                        ...
                        else //RER Y REG
                        {
                            ...
                            {
                                InsertarEstadoCuentaDiseñador();
                                InsertarDocumentoVenta(Convert.ToInt32(valueId), "BOV");
                                //       ImpresionDirecta("BOV", objCajaEmpresa.IdTipoFormato);  impresión de formatos de BOletas
                                Cargar();
                                return;
                            ...
                            {
                                InsertarEstadoCuentaDiseñador();
                                InsertarDocumentoVentaVarios(6, Convert.ToInt32(valueId), "BOV");
                                //ImpresionDirecta("BOV", objCajaEmpresa.IdTipoFormato);
                                Cargar();
                                return;
                            }
                ...
                objE_Talon = new TalonBL().SeleccionaCajaDocumento(Convert.ToInt32(valueId), Parametros.intTiendaId, Parametros.intCajaId, Convert.ToInt32(cboDocumento.EditValue));
                if (objE_Talon != null)
                {
                    Serie = "";
                ...
                if (Convert.ToInt32(cboDocumento.EditValue) == Parametros.intTipoDocFacturaVenta) //CUANDO ES FACTURA DE VENTA
                {
                    ...
                    if (IdTipoDocumentoCliente == Parametros.intTipoDocumentoRUC && IdTipoDocumentoClienteAsociado == 0)
                    {
                        ...
                        {
                            InsertarEstadoCuentaDiseñador();
                            InsertarDocumentoVenta(Convert.ToInt32(valueId), "FAV");
                        ...
                        else
                        {
                            //validar ruc
                            InsertarEstadoCuentaDiseñador();
                            InsertarDocumentoVentaVarios(10, Convert.ToInt32(valueId), "FAV");
                            ImpresionDirecta("FAV", objE_Talon.IdTipoFormato);
                        }
                    }
                ...
                {
                    InsertarEstadoCuentaDiseñador();
                    InsertarDocumentoVenta(Convert.ToInt32(valueId), "TKV");
                ...
                if (Convert.ToInt32(cboDocumento.EditValue) == Parametros.intTipoDocTicketFactura)
                {
                    ...
                    {
                        InsertarEstadoCuentaDiseñador();
                        InsertarDocumentoVenta(Convert.ToInt32(valueId), "TKF");
                ...
                if (Convert.ToInt32(cboDocumento.EditValue) == Parametros.intTipoDocBoletaElectronica)
                {
                    ...
                    InsertarEstadoCuentaDiseñador();
                    InsertarDocumentoVenta(Convert.ToInt32(valueId), "TEB");
                ...
                if (Convert.ToInt32(cboDocumento.EditValue) == Parametros.intTipoDocFacturaElectronica)
                {
                    ...
                    {
                        InsertarEstadoCuentaDiseñador();
                        InsertarDocumentoVenta(Convert.ToInt32(valueId), "TEF");
        ...
        private bool ProcesoBoleteoRER(Boolean parFlagImpresionRus, int parIdTipoCliente, int parTipoDocFact, int parIdTipoFormato)
        {
            ...
            EmpresaBE objE_Empresa = null;
            objE_Empresa = new EmpresaBL().Selecciona(valueId);
            if (objE_Empresa != null)
            {
                if (objE_Empresa.IdRegimenTributario == Parametros.intRegimenTributarioRUS)// solo Rus
                {
                    ...
                    if (!ValidarTopeEmpresaRus()) //Mensual
                    {
                        if (!ValidarTopeEmpresaDiarioRus()) //Diario
                        {
                            if (valueId == 3 || valueId == 19 || valueId == 21 || valueId == 23 || valueId == 8 || valueId == 20)
                            {
                                // Validacion de cliente mayorista para RER
        ...
        private void txtIngresa_KeyDown(object sender, KeyEventArgs e)
        {
            if (Convert.ToDecimal(txtTotal.Text) > 0)
            {
                if (e.KeyCode == Keys.F8)
                {
                    ...
                    {
                        mListaPedidoDetalleOrigen = mListaDetalle;
                        //CalculaTotalPromocion2x1_Total();// ecm 2022
                        objE_Pedido.TotalDiferencia = 0;
                    }

                    #endregion
                    //XtraMessageBox.Show("Empresa==>" + IdEmpresa, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Error);
                    ...
                    frmMsgPago.IdClasificacionCliente = int.Parse(gvPedido.GetFocusedRowCellValue("IdClasificacionCliente").ToString());
                    ...
                    if (frmMsgPago.DialogResult == DialogResult.OK)
                    {
                        ...
                        if (Convert.ToInt32(cboDocumento.EditValue) == Parametros.intTipoDocBoletaElectronica)  // Boleta Electronica Panorama
                        {
                            #region "Diferencia cabecera vs detalle"
                        ...
                        if (Convert.ToInt32(cboDocumento.EditValue) == Parametros.intTipoDocFacturaElectronica)  // Factura Electronica Panorama
                        {
                            #region "Diferencia cabecera vs detalle"
                            if (objE_Pedido.TotalDiferencia != 0)
                            {
        ...
        private void InsertarDocumentoVenta(int IdEmpresaGenera, string TipoDoc)
        {
            try
            {
                ...
                objDocumentoVenta.FlagCumpleanios = objE_Pedido.FlagCumpleanios;
                objDocumentoVenta.TotalDscCumpleanios = objE_Pedido.TotalDscCumpleanios;
                ...
                objE_MovimientoCaja.IdTipoDocumento = Convert.ToInt32(cboDocumento.EditValue);   //objDocumentoVenta.IdTipoDocumento;
        ...
        private void ImpresionDirecta(String TipoDoc, Int32 TipoFormato)  //REVISAR AQUI EL FORMATO//////////************************
        {
            try
            {
                ...
                if (Parametros.intTiendaId == Parametros.intTiendaSanMiguel)
                {
                    dirFacturacion = Parametros.strDireccionSanMiguel;
                }
        ...
        private bool ValidarTopeEmpresaRus()
        {
            ...
            if (flag)
            {
                // XtraMessageBox.Show(strMensaje + ": Por TOPE Mensual.", this.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                //Cursor = Cursors.Default;
            }
            return flag;
        }
        private bool ValidarTopeEmpresaDiarioRus()
        {
            ...
            if (valueId != Parametros.intPanoraramaDistribuidores)
            {
                /// *****************************************************************************************
                TopeEmpresaBE objE_TopeEmpresa = new TopeEmpresaBE();
                objE_TopeEmpresa = new TopeEmpresaBL().Selecciona(Convert.ToInt32(valueId));
               ...
               // decimal Tope = Parametros.dmlTopeEmpresaDiarioRUS;
                //decimal Tope = Parametros.dmlTopeEmpresaDiarioRUS;
                DocumentoVentaBE objE_Documento = new DocumentoVentaBE();
                objE_Documento = new DocumentoVentaBL().SeleccionaEmpresaFecha(Convert.ToInt32(valueId), Convert.ToDateTime(deFecha.DateTime.ToShortDateString()), Convert.ToDateTime(deFecha.DateTime.ToShortDateString()));
            ...
            if (flag)
            {
                      XtraMessageBox.Show(strMensaje + ": Por tope diario.", this.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                //Cursor = Cursors.Default;
            }
            return flag;
        }
        ...
        private void InsertarDocumentoVentaRUS()
        {
            try
            {
                ...
                if (valueId == 3 || valueId == 19 || IdEmpresa == 21 || IdEmpresa == 23 || IdEmpresa == 8 || IdEmpresa == 20)
                {
                ...
                objDocumentoVenta.Usuario = Parametros.strUsuarioLogin;
                objDocumentoVenta.Maquina = WindowsIdentity.GetCurrent().Name.ToString();
                objDocumentoVenta.IdEmpresa = valueId;
                objDocumentoVenta.IdAlmacen = IdAlmacen;
                objDocumentoVenta.CodigoNC = CodigoNC;
                ...
                objE_MovimientoCaja.IdTipoDocumento = valueId == 3 || valueId == 19 || valueId == 21 || valueId == 23 || valueId == 8 || valueId == 20 ? Parametros.intTipoDocBoletaElectronica : Parametros.intTipoDocBoletaVenta;   //Parametros.intTipoDocBoletaVenta;
                objE_MovimientoCaja.NumeroDocumento = Serie + "-" + Numero;
                objE_MovimientoCaja.IdFormaPago = objE_Pedido.IdFormaPago;
                objE_MovimientoCaja.IdCondicionPago = Convert.ToInt32(cboCondicionPago.EditValue);
                objE_MovimientoCaja.TipoMovimiento = "I";
                ...
                objE_MovimientoCaja.Usuario = Parametros.strUsuarioLogin;
                objE_MovimientoCaja.Maquina = WindowsIdentity.GetCurrent().Name.ToString();
                objE_MovimientoCaja.IdEmpresa = valueId;
                ...
                {
                    DocumentoVentaPagoBE objE_Pago = new DocumentoVentaPagoBE();
                    objE_Pago.IdEmpresa = valueId;
                    objE_Pago.IdDocumentoVenta = 0;
                    objE_Pago.IdDocumentoVentaPago = 0;
                    objE_Pago.Fecha = Convert.ToDateTime(deFecha.DateTime.ToShortDateString());

                    objE_Pago.IdTipoDocumento = valueId == 3 || valueId == 19 || valueId == 21 || valueId == 23 || valueId == 8 || valueId == 20 ? Parametros.intTipoDocBoletaElectronica : Parametros.intTipoDocBoletaVenta;
                    objE_Pago.NumeroDocumento = Serie + "-" + Numero;
                    objE_Pago.IdCondicionPago = Convert.ToInt32(cboCondicionPago.EditValue);
                    objE_Pago.IdMoneda = Convert.ToInt32(cboMonedaPago.EditValue);
                    objE_Pago.TipoCambio = Convert.ToDecimal(txtTC.EditValue);
                ...
                if (pOperacion == Operacion.Nuevo)
                {
                    if (valueId == 3 || valueId == 19 || valueId == 21 || valueId == 23 || valueId == 8 || valueId == 20)
                    {
                        ...
                        //    #region "Impresión"
                        TalonBE objTalon = null;
                        objTalon = new TalonBL().SeleccionaCajaDocumento(valueId, Parametros.intTiendaId, Parametros.intCajaId, Convert.ToInt32(cboDocumento.EditValue));
                        ImpresionElectronicaLocal(vIdDocumentoVenta, objTalon.IdTamanoHoja, objTalon.Impresora, valueId);
                    }
                    else
                    {
                        objBL_DocumentoVenta.InsertaDocumentoContado(objDocumentoVenta, lstDocumentoVentaDetalle, objE_MovimientoCaja, lstDocumentoVentaPago);
        ...
        private void InsertarDocumentoVentaRUSPorTipDoc(int pTipoDocumentoBF)
        {
            try
            {
                ...
                if (valueId == 3 || valueId == 19 || valueId == 21 || valueId == 23 || valueId == 8 || valueId == 20)
                {
                    mListaNumero = new NumeracionDocumentoBL().ObtenerCorrelativoSerie(valueId, pTipoDocumentoBF, SerieRUS);
                    //mListaNumero = new NumeracionDocumentoBL().ObtenerCorrelativoSerie(Convert.ToInt32(cboEmpresa.EditValue), Parametros.intTipoDocBoletaElectronica, SerieRUS);
                }
                else
                {
                    mListaNumero = new NumeracionDocumentoBL().ObtenerCorrelativoSerie(valueId, Parametros.intTipoDocBoletaVenta, SerieRUS);
                }
                ...
                foreach (var item in mListaDetalle)
                {
                    ...
                    objE_DocumentoVentaDetalle.FlagEstado = true;
                    objE_DocumentoVentaDetalle.TipoOper = item.TipoOper;
                    //objE_DocumentoVentaDetalle.Observ = item.Observacion;
                ...
                objE_MovimientoCaja.IdCaja = Parametros.intCajaId;
                objE_MovimientoCaja.Fecha = Convert.ToDateTime(deFecha.DateTime.ToShortDateString());
                objE_MovimientoCaja.IdTipoDocumento = valueId == 3 || valueId == 19 || valueId == 21 || valueId == 23 || valueId == 8 || valueId == 20 ? pTipoDocumentoBF : Parametros.intTipoDocBoletaVenta;   //Parametros.intTipoDocBoletaVenta;
                ...
                if (mListaDocumentoVentaPagoOrigen.Count == 0)
                {
                    ...
                    objE_Pago.IdTipoDocumento = valueId == 3 || valueId == 19 || valueId == 21 || valueId == 23 || valueId == 8 || valueId == 20 ? pTipoDocumentoBF : Parametros.intTipoDocBoletaVenta;
        ...
        private void InsertarDocumentoVentaPagoVariosRUS(decimal Efectivo, decimal Visa, decimal MasterCard, decimal VisaPuntosVida, decimal MasterCardPuntosVida, string TipoVisa, string TipoMaster, int IdDocumentoNC, int IdTipoMaster, int pTipoDocBolFac)
        {
            try
            {
                ...
                if (Cupon > 0) //--------------------------------------------------------
                {
                    ...
                    objE_MovimientoCaja.NumeroDocumento = Serie + "-" + Numero;
                    objE_MovimientoCaja.IdFormaPago = objE_Pedido.IdFormaPago;
                    objE_MovimientoCaja.IdCondicionPago = Parametros.intCupon; // Parametros.intCupon; ;
        ...
        private void InsertarDocumentoVentaPagoVarios(decimal Efectivo, decimal Visa, decimal MasterCard, decimal VisaPuntosVida, decimal MasterCardPuntosVida, string TipoVisa, string TipoMaster, int IdDocumentoNC, int IdTipoMaster, int IdEmpresaGenera, string TipoDoc)
        {
            try
            {
                ...
                if (Cupon > 0) //--------------------------------------------------------
                {
                    ...
                    objE_MovimientoCaja.NumeroDocumento = Serie + "-" + Numero;
                    objE_MovimientoCaja.IdFormaPago = objE_Pedido.IdFormaPago;
                    objE_MovimientoCaja.IdCondicionPago = Parametros.intCupon;   //324;// Parametros.intGiftCard;     // Parametros.intCupon; ;
                    objE_MovimientoCaja.NumeroCondicion = NumeroCupon;
                    objE_MovimientoCaja.TipoTarjeta = null;
                    objE_MovimientoCaja.TipoMovimiento = "I";
                    objE_MovimientoCaja.IdMoneda = Convert.ToInt32(cboMonedaPago.EditValue);
                ...
                if (objTalon.NumeroAutoriza == "TERMICA")
                {
                    ...
                    else if (parIdEmpresa == 19)
                    {
                        ...
                        for (int i = 1; i <= 3; i++)
                        {
                            ...
                            ticket.TextoCentro("VENTA DE ADORNOS PARA EL HOGAR");
                            ticket.TextoCentro("CRISTALERIA, LAMPARAS Y MANTELERIA");
                            ticket.TextoIzquierdaNLineas(objTalon.DireccionFiscal);
                            //if (objTalon.IdTienda == Parametros.intTiendaMegaplaza) ticket.TextoCentro("INDEPENDENCIA - LIMA - LIMA");
                            ...
                            ticket.TextoCentro(objTalon.NumeroSerie + "-" + Numero);
                            ticket.TextoIzquierda("");
                            ticket.TextoIzquierda("FECHA: " + DateTime.Now.ToShortDateString() + " " + DateTime.Now.ToShortTimeString());
                            ticket.TextoIzquierda("CAJA: " + objTalon.DescCaja + " (" + Parametros.strUsuarioLogin + ")");
                            ticket.TextoIzquierda("DNI/RUC: " + lstReporte[0].NumeroDocumento);
                            ticket.TextoIzquierdaNLineas("CLIENTE: " + lstReporte[0].DescCliente);
                            if (Convert.ToInt32(cboDocumento.EditValue) == Parametros.intTipoDocFacturaElectronica) ticket.TextoIzquierdaNLineas("DIR: " + lstReporte[0].Direccion);
