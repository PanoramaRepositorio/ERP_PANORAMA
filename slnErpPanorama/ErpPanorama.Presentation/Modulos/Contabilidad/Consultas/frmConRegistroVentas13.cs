...
{
    public partial class frmConRegistroVentas13 : DevExpress.XtraEditors.XtraForm
    {
        #region "Propiedades"
        ...
        public frmConRegistroVentas13()
        {
            InitializeComponent();
        }

        private void frmConRegistroVentas13_Load(object sender, EventArgs e)
        {
        ...
        private void Cargar()
        {
            mLista = new DocumentoVentaBL().ListaGeneralPD(0, deDesde.DateTime, deHasta.DateTime);
        ...
        private void CalcularTotalDocumentos()
        {
            try
            {
                ...
                for (int i = 0; i < gvDocumento.RowCount; i++)
                {
                    ...
                    decTotalSoles = decTotalSoles + Convert.ToDecimal(gvDocumento.GetRowCellValue(i, (gvDocumento.Columns["TotalSoles"])));
                }
                txtTotal.EditValue = decTotal;
                txtTotalGeneral.EditValue = decTotalSoles;
