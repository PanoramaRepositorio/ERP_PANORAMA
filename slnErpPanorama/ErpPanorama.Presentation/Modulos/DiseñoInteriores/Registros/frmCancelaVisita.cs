...
{
    public partial class frmCancelaVisita : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmCancelaVisita()
        {
            InitializeComponent();
        }

        private void frmCancelaVisita_Load(object sender, EventArgs e)
        {
        ...
        private void btnGrabar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    XtraMessageBox.Show("Ingrese el motivo de la cancelación de la visita.", this.Text, MessageBoxButtons.OK, MessageBoxIcon.Information);
                    txtMotivoAnulacion.Select();
                    return;
                }

                objAgenda.IdAgendaVisita = IdAgenda;
                objAgenda.DescCancelacion = txtMotivoAnulacion.Text.Trim();
                objAgenda.IdSituacion = Parametros.intCancelado;

                objBL_Agenda.CancelaVisita(objAgenda);
                XtraMessageBox.Show("Se registro la cancelación de la visita.", this.Text, MessageBoxButtons.OK, MessageBoxIcon.Information);
                this.Close();
            }
            catch (Exception ex)
            {
