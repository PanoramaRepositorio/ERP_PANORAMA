...
{
    public partial class frmManProductoProforma : DevExpress.XtraEditors.XtraForm
    {
        #region "Propiedades"
        ...
        {
            get { return _ModeloProducto; }
            set { _ModeloProducto = value; }
        }
        ...
        public frmManProductoProforma()
        {
            InitializeComponent();
        }

        private void frmManProductoProforma_Load(object sender, EventArgs e)
        {
        ...
        private void btnGrabar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!ValidarIngreso())
                {
                    ...
                    //if (pOperacion == Operacion.Nuevo)
                    //{
                    //  //  IdProducto = objBL_Producto.InsertaProforma(objE_Producto, objE_ProductoFoto);
                    //}
                    //else
                    //{
                    //    //objE_ProductoFoto.TipoOper = Convert.ToInt32(Operacion.Nuevo);
                    //    //objBL_Producto.ActualizaProforma(objE_Producto, objE_ProductoFoto);

                    //    ////Asociados
                    //    //ProductoAsociadoBL objBL_ProductoAsociado = new ProductoAsociadoBL();
                    //    //objBL_ProductoAsociado.Inserta2(lstProductoAsociado);
                    //}
                    CodigoProveedor = txtCodigoProveedor.Text;
                    NombreProducto = txtNombreProducto.Text;
                    ModeloProducto = cboModelo.Text.Trim();
                    MaterialProducto = cboMaterial.Text.Trim();
                    MedidaProducto = txtMedida.Text;
                    this.Close();
                }
            }
            catch (Exception ex)
