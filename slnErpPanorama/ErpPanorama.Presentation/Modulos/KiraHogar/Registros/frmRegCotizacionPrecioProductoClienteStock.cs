    ...
    public partial class frmCotizacion : DevExpress.XtraEditors.XtraForm
    {
        ...
        private string ObtenerNombreTablaElemento(int idTablaElemento)
        {
            ...
            Dictionary<int, string> nombresTablaElemento = new Dictionary<int, string>
                {
                    { Parametros.idACERO, Parametros.materiales},
                    { Parametros.idBRONCE, Parametros.materiales },
                    { Parametros.idCASO, Parametros.materiales },
                    { Parametros.idESPUMA, Parametros.materiales },
                    { Parametros.idESPEJO, Parametros.materiales },
                    { Parametros.idFIERRO, Parametros.materiales },
                    { Parametros.idMADERA, Parametros.materiales },
                    { Parametros.idMDF, Parametros.materiales },
                    { Parametros.idMELAMINE, Parametros.materiales},
                    { Parametros.idNAPA, Parametros.materiales},
                    { Parametros.idNOTEX, Parametros.materiales },
                    { Parametros.idPIEDRA, Parametros.materiales },
                    { Parametros.idTELA, Parametros.materiales },
                    { Parametros.idVIDRIO, Parametros.materiales },
                    { Parametros.idENCHAPE, Parametros.materiales },
                    { Parametros.idCARTON_PRENSADO, Parametros.insumos },
                    { Parametros.idCRUDO, Parametros.insumos  },
                    { Parametros.idNOSAG, Parametros.insumos },
                    { Parametros.idPINTURA, Parametros.insumos },
                    { Parametros.idPOLISEA, Parametros.insumos },
                    { Parametros.idBISAGRAS, Parametros.accesorios },
                    { Parametros.idCORREDERAS, Parametros.accesorios },
                    { Parametros.idTIRADORES, Parametros.accesorios},
                    { Parametros.idILUMINACION, Parametros.accesorios },
                    { Parametros.idPATASZOCALO, Parametros.accesorios },
                    { Parametros.idPATASMADERA, Parametros.accesorios},
                    { Parametros.idPATASMETALICAS, Parametros.accesorios },
                    { Parametros.idCARPINTERIA, Parametros.manodeobra },
                    { Parametros.idCOSTURERO, Parametros.manodeobra},
                    { Parametros.idELECTRICISTA, Parametros.manodeobra },
                    { Parametros.idESAMBLADOR, Parametros.manodeobra },
                    { Parametros.idPINTURAS, Parametros.manodeobra },
                    { Parametros.idSOLDADOR, Parametros.manodeobra },
                    { Parametros.idTAPICERO, Parametros.manodeobra },
                    { Parametros.idVIDRIERO, Parametros.manodeobra},
                    { Parametros.idPASAJEDISENADORA, Parametros.movilidadyViatios},
                    { Parametros.idPASAJEPARAENTREGA, Parametros.movilidadyViatios },
                    { Parametros.idPASAJEPRODUCCION, Parametros.movilidadyViatios },
                    { Parametros.idVIATICOS, Parametros.movilidadyViatios},
                    { Parametros.idequiposHerramientas, Parametros.dequiposHerramientas },
