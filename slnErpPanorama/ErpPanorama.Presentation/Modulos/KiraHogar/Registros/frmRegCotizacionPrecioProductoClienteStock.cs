    ...
    public partial class frmCotizacion : DevExpress.XtraEditors.XtraForm
    {
        ...
        private string ObtenerNombreTablaElemento(int idTablaElemento)
        {
            ...
            Dictionary<int, string> nombresTablaElemento = new Dictionary<int, string>
                {
                    { Parametros.idACERO, "MATERIALES" },
                    { Parametros.idBRONCE, "MATERIALES" },
                    { Parametros.idCASO, "MATERIALES" },
                    { Parametros.idESPUMA, "MATERIALES" },
                    { Parametros.idESPEJO, "MATERIALES" },
                    { Parametros.idFIERRO, "MATERIALES" },
                    { Parametros.idMADERA, "MATERIALES" },
                    { Parametros.idMDF, "MATERIALES" },
                    { Parametros.idMELAMINE, "MATERIALES" },
                    { Parametros.idNAPA, "MATERIALES" },
                    { Parametros.idNOTEX, "MATERIALES" },
                    { Parametros.idPIEDRA, "MATERIALES" },
                    { Parametros.idTELA, "MATERIALES" },
                    { Parametros.idVIDRIO, "MATERIALES" },
                    { Parametros.idENCHAPE, "MATERIALES" },
                    { Parametros.idCARTON_PRENSADO, "INSUMOS" },
                    { Parametros.idCRUDO, "INSUMOS" },
                    { Parametros.idNOSAG, "INSUMOS" },
                    { Parametros.idPINTURA, "INSUMOS" },
                    { Parametros.idPOLISEA, "INSUMOS" },
                    { Parametros.idBISAGRAS, "ACCESORIOS" },
                    { Parametros.idCORREDERAS, "ACCESORIOS" },
                    { Parametros.idTIRADORES, "ACCESORIOS" },
                    { Parametros.idILUMINACION, "ACCESORIOS" },
                    { Parametros.idPATASZOCALO, "ACCESORIOS" },
                    { Parametros.idPATASMADERA, "ACCESORIOS" },
                    { Parametros.idPATASMETALICAS, "ACCESORIOS" },
                    { Parametros.idCARPINTERIA, "MANO DE OBRA" },
                    { Parametros.idCOSTURERO, "MANO DE OBRA" },
                    { Parametros.idELECTRICISTA, "MANO DE OBRA" },
                    { Parametros.idESAMBLADOR, "MANO DE OBRA" },
                    { Parametros.idPINTURAS, "MANO DE OBRA" },
                    { Parametros.idSOLDADOR, "MANO DE OBRA" },
                    { Parametros.idTAPICERO, "MANO DE OBRA" },
                    { Parametros.idVIDRIERO, "MANO DE OBRA" },
                    { Parametros.idPASAJEDISENADORA, "MOVILIDAD Y VIATICOS" },
                    { Parametros.idPASAJEPARAENTREGA, "MOVILIDAD Y VIATICOS" },
                    { Parametros.idPASAJEPRODUCCION, "MOVILIDAD Y VIATICOS" },
                    { Parametros.idVIATICOS, "MOVILIDAD Y VIATICOS" },
                    { Parametros.idequiposHerramientas, "EQUIPOS Y HERRAMIENTAS" },
