...
namespace ErpPanorama.Presentation.Modulos.RecursosHumanos.Registros
{
    public partial class frmRegHoraExtraEdit : DevExpress.XtraEditors.XtraForm
    {
        ...
        private bool ValidarIngreso()
        {
            ...
            if (pOperacion == Operacion.Nuevo && Parametros.intPerfilId != Parametros.intPerAdministrador)
            {
                List<HoraExtraBE> lstHoraExtra = null;
                lstHoraExtra = new HoraExtraBL().ListaPersonaFecha(IdPersona, Convert.ToDateTime(deFechaDesde.EditValue), Convert.ToDateTime(deFechaDesde.EditValue));
