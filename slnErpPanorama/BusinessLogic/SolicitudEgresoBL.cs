...
{
    public class SolicitudEgresoBL
    {
        ...
        public List<SolicitudEgresoBE> ListaTodosActivo(DateTime pFechaInicio, DateTime pFechaFin, int pIdPersona)
        {
            try
            {
                ...
                return DocumentoVenta.ListaTodosActivo(pFechaInicio, pFechaFin, pIdPersona);
            }
            catch (Exception ex)
            { throw ex; }
        }
        ...
        public List<SolicitudEgresoBE> ListaFechaCajaChica(DateTime FechaDesde, DateTime FechaHasta)
        {
            ...
            {
                SolicitudEgresoDL SolicitudEgreso = new SolicitudEgresoDL();
                return SolicitudEgreso.ListaFechaCajaChica(FechaDesde, FechaHasta);
            }
            catch (Exception ex)
            { throw ex; }
        }
        ...
        public SolicitudEgresoBE Buscar_Recibo(string NumRecibo)
        {
            ...
            {
                SolicitudEgresoDL SolicitudEgreso = new SolicitudEgresoDL();
                return SolicitudEgreso.Buscar_Recibo(NumRecibo);
            }
            catch (Exception ex)
            { throw ex; }
        }
