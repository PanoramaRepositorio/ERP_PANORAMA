...
{
    public class ReporteMovimientoAlmacenFaltanteOrigenDL
    {
        public List<ReporteMovimientoAlmacenFaltanteOrigenBE> ListadoFaltanteOrigen(int IdEmpresa, DateTime FechaDesde, DateTime FechaHasta)
        {
            ...
            DbCommand dbCommand = db.GetStoredProcCommand("usp_rptFaltantesOrigen");
            db.AddInParameter(dbCommand, "pIdEmpresa", DbType.Int32, IdEmpresa);
            db.AddInParameter(dbCommand, "@pFechaDesde", DbType.DateTime, FechaDesde);
            db.AddInParameter(dbCommand, "@pFechaHasta", DbType.DateTime, FechaHasta);

            IDataReader reader = db.ExecuteReader(dbCommand);
            List<ReporteMovimientoAlmacenFaltanteOrigenBE> MovimientoAlmacenlist = new List<ReporteMovimientoAlmacenFaltanteOrigenBE>();
            ReporteMovimientoAlmacenFaltanteOrigenBE MovimientoAlmacen;
            while (reader.Read())
            {
                MovimientoAlmacen = new ReporteMovimientoAlmacenFaltanteOrigenBE();
