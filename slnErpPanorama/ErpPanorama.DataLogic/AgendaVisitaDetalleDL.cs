...
{
    public class AgendaVisitaDetalleDL
    {
        public AgendaVisitaDetalleDL() { }

        public Int32 Inserta(SolicitudEgresoDetalleBE pItem)
        {
            Int32 Id = 0;
            Database db = DatabaseFactory.CreateDatabase("cnErpPanoramaBD");
            DbCommand dbCommand = db.GetStoredProcCommand("usp_SolicitudEgresoDetalle_Inserta");
            ...
            Id = (int)db.GetParameterValue(dbCommand, "pIdSolicitudEgresoDetalle");

            return Id;
        }


        public void Actualiza_E(SolicitudEgresoDetalleBE pItem)
        {
            Database db = DatabaseFactory.CreateDatabase("cnErpPanoramaBD");
        ...
        public void Actualiza_Pagos(SolicitudEgresoDetalleBE pItem)
        {
            Database db = DatabaseFactory.CreateDatabase("cnErpPanoramaBD");
        ...
        public void EliminaFisico(SolicitudEgresoDetalleBE pItem)
        {
            Database db = DatabaseFactory.CreateDatabase("cnErpPanoramaBD");
        ...
        public List<SolicitudEgresoDetalleBE> ListaTodosActivo(int IdSolicitudEgreso)
        {
            Database db = DatabaseFactory.CreateDatabase("cnErpPanoramaBD");
            ...
            List<SolicitudEgresoDetalleBE> DocumentoVentaDetallelist = new List<SolicitudEgresoDetalleBE>();
            SolicitudEgresoDetalleBE DocumentoVentaDetalle;
            while (reader.Read())
            {
                DocumentoVentaDetalle = new SolicitudEgresoDetalleBE();
                ...
                //DocumentoVentaDetalle.fname = (reader["fname"].ToString());
                //DocumentoVentaDetalle.tipo = (reader["tipo"].ToString());

                //if (reader["fcontent"] != DBNull.Value)
                //    DocumentoVentaDetalle.fcontent = (byte[])reader["fcontent"];
        ...
        public List<SolicitudEgresoDetalleBE> ListaTodosActivoFE(int IdEmpresa, int IdDocumentoVenta)
        {
            Database db = DatabaseFactory.CreateDatabase("cnErpPanoramaBD");
        ...
        public List<SolicitudEgresoDetalleBE> ListaTodosActivoFE_RER(int IdEmpresa, int IdDocumentoVenta)
        {
            Database db = DatabaseFactory.CreateDatabase("cnErpPanoramaBD");
        ...
        public List<SolicitudEgresoDetalleBE> ListaPedido(int IdDocumentoVenta)
        {
            Database db = DatabaseFactory.CreateDatabase("cnErpPanoramaBD");
        ...
        public List<SolicitudEgresoDetalleBE> ListaEmpresaTraslado(int IdEmpresa, DateTime FechaDesde, DateTime  FechaHasta)
        {
            Database db = DatabaseFactory.CreateDatabase("cnErpPanoramaBD");
        ...
        public List<SolicitudEgresoDetalleBE> ListaSolicitudEgresoDetalle(int IdSolicitudEgreso)
        {
            Database db = DatabaseFactory.CreateDatabase("cnErpPanoramaBD");
            ...
            IDataReader reader = db.ExecuteReader(dbCommand);
            List<SolicitudEgresoDetalleBE> CuentaBancoDetallelist = new List<SolicitudEgresoDetalleBE>();
            SolicitudEgresoDetalleBE SolicitudEgresoDetalle;
            while (reader.Read())
            {
                SolicitudEgresoDetalle = new SolicitudEgresoDetalleBE();
