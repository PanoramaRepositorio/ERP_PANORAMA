...
{
    public class EscalaMayoristaDL
    {
        public EscalaMayoristaDL()  { }


        public void Inserta(EscalaMayoristaBE pItem)
        {
            Database db = DatabaseFactory.CreateDatabase("cnErpPanoramaBD");
            DbCommand dbCommand = db.GetStoredProcCommand("usp_EscalaMayorista_Inserta");

            db.AddInParameter(dbCommand, "pIdEscalaMayorista", DbType.Int32, pItem.IdEscalaMayorista);
        ...
        {
            Database db = DatabaseFactory.CreateDatabase("cnErpPanoramaBD");
            DbCommand dbCommand = db.GetStoredProcCommand("usp_EscalaMayorista_Actualiza");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase("cnErpPanoramaBD");
            DbCommand dbCommand = db.GetStoredProcCommand("usp_EscalaMayorista_Elimina");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase("cnErpPanoramaBD");
            DbCommand dbCommand = db.GetStoredProcCommand("usp_EscalaMayorista_ListaTodosActivo");
            ...
            while (reader.Read())
            {
                ...
                eItem.IdEscalaMayorista = Int32.Parse(reader["IdEscalaMayorista"].ToString());
